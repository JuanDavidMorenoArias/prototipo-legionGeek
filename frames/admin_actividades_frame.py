...
class AdminActividadesFrame(tk.Frame):
    ...
    def create_widgets(self):
        titulo = tk.Label(self, text="Plantear Actividad", font=("Arial", 20, "bold"))
